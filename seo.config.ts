export const defaultSEOConfig = {
  uz: {
    ...
    facebook: {
      appId: "1234567890",
      pageUrl: "https://www.facebook.com/icg.uzb/",
    },
  ...
  ru: {
    ...
    openGraph: {
      ...
      locale: "ru_RU",
      url: "https://icg.uz",
      title: "ICG - Консалтинговый и развивающий центр",
      description:
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "ICG Консалтинговый и развивающий центр",
        },
      ],
      site_name: "ICG",
    },
    ...
    additionalMetaTags: [
      {
        name: "keywords",
        content:
          "ICG, консультации, развивающий центр, бизнес-консалтинг, финансовые консультации, развитие персонала, Узбекистан",
      },
      {
        name: "author",
        content: "ICG Uzbekistan",
  ...
  en: {
    ...
    openGraph: {
      ...
      locale: "en_US",
      url: "https://icg.uz",
      title: "ICG - Consulting and Development Center",
      description:
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "ICG Consulting and Development Center",
        },
      ],
      site_name: "ICG",
    },
    ...
    additionalMetaTags: [
      {
        name: "keywords",
        content:
          "ICG, consulting, development center, business consulting, financial advice, staff development, Uzbekistan",
      },
      {
        name: "author",
        content: "ICG Uzbekistan",
